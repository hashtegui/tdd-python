from leilao.dominio import Leilao, Usuario
import pytest
...
def test_deve_subtrair_valor_da_carteira_do_usuario_quando_este_propor_uma_lance(vini, leilao):
...
def test_deve_permitir_propor_lance_quando_o_valor_e_igual_o_valor_da_carteira(vini, leilao):
